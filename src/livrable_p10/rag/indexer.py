...
from livrable_p10.rag.utils.config import INPUT_DIR # INPUT_DATA_URL (décommentez si besoin)
from livrable_p10.rag.utils.data_loader import download_and_extract_zip, load_and_parse_files
